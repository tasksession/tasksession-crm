...
/*
 ================================================================================
   ...
   File    : overview.php
   Purpose : Displays project and system overview information for staff
 ================================================================================
 */
ob_start();
...
if(!$projectId){
    redirectTo($url."staff/projects.php");
}
...
if (!has_permission('project_view_all') && strpos($project->s_ids, $id) === false){
    redirectTo($url."staff/projects.php?message=unauthorized");
}

include(__DIR__ . '/../includes/project-sidebar-data.php');

$overviewPortal = 'staff';
