...
if (!has_permission('project_view_all') && strpos((string) $project->s_ids, (string) $id) === false) {
	redirectTo($url . "staff/projects?message=unauthorized");
}

$profileNotesCsrfToken = function_exists('generate_csrf_token') ? generate_csrf_token() : '';
$projectNotesCreatorType = 'staff';
