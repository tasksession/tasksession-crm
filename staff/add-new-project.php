...
if (isset($_POST['add-project'])) {
    ...
    $project->trash         = 0;
    $project->start_time    = $start_raw;
    $project->end_time      = $end_raw;
    ...
    if ($saveProject) {
        ...
        if (isset($_POST['notifyClient'])) {
            ...
            $templateHTML = $adminSettings->project_assign_email;
            ...
            foreach ($all_users as $recentlyRegisteredUser) {
                if ($recentlyRegisteredUser->accountStatus == 3 || $recentlyRegisteredUser->accountStatus == 1) {
                    ...
                    if (in_array((int)$recentlyRegisteredUser->id, $s_all)) {
                        ...
                        $templateHTML = $adminSettings->assign_staff_email;
                                    ...
                                    <div class="col-md-12 center-col">
                                        ...
                                        <div class="form-group field-label">
                                            ...
                                            <textarea
                                                ...
                                                name="description"
                                                class="form-control"
                                                placeholder="<?php echo $lang['Describe the project']; ?>"
                                            ></textarea>
                                            <?php
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        />
                                                        <small id="project-staff-error" class="text-danger d-none"><?php echo isset($lang['Please select at least one team member or admin']) ? htmlspecialchars($lang['Please select at least one team member or admin'], ENT_QUOTES, 'UTF-8') : 'Please select at least one team member or admin.'; ?></small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
